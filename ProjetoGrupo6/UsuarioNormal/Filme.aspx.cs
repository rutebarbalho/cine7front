...
namespace ProjetoGrupo6.UsuarioNormal
{
    public partial class Filme : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // define SQL do comando
            cmd2.CommandText = "Select dataHora FROM RelacaoFavorito where usuario = @usuario";
            ...
            // define SQL do comando
            cmd3.CommandText = "Select dataHora FROM RelacaoInteresse where usuario = @usuario";
            ...
            // define SQL do comando
            cmd4.CommandText = "Select dataHora FROM RelacaoVisto where usuario = @usuario";
            ...
            /*EXCLUSÃO SÓ PARA USUÁRIO QUE FIZERAM O COMENTÁRIO*/
            foreach (DataListItem label in DataList1.Items)
            {
                if (label.ToString() == Session["usuario"])
                {
                    label.Visible = false;
                }
            }
            /*if (DataList1.DataKeyField.Equals == "Nestor") 
            { 
                string keyID; 
            ...
            ImageButtonEstrela1.Attributes.Add("onmouseover", "this.ImageUrl='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela1.Attributes.Add("onmouseout", "this.ImageUrl='~/Imagens/estrelaApagada.jpg'");

            ImageButtonEstrela2.Attributes.Add("onmouseover", "this.src='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela2.Attributes.Add("onmouseout", "this.src='~/Imagens/estrelaApagada.jpg'");

            ImageButtonEstrela3.Attributes.Add("onmouseover", "this.src='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela3.Attributes.Add("onmouseout", "this.src='~/Imagens/estrelaApagada.jpg'");

            ImageButtonEstrela4.Attributes.Add("onmouseover", "this.src='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela4.Attributes.Add("onmouseout", "this.src='~/Imagens/estrelaApagada.jpg'");

            ImageButtonEstrela5.Attributes.Add("onmouseover", "this.src='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela5.Attributes.Add("onmouseout", "this.src='~/Imagens/estrelaApagada.jpg'");

            ImageButtonEstrela6.Attributes.Add("onmouseover", "this.src='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela6.Attributes.Add("onmouseout", "this.src='~/Imagens/estrelaApagada.jpg'");

            ImageButtonEstrela7.Attributes.Add("onmouseover", "this.src='~/Imagens/estrelaAcesa.jpg'");
            ImageButtonEstrela7.Attributes.Add("onmouseout", "this.src='~/Imagens/estrelaApagada.jpg'");
        }
        ...
        protected void LinkButtonApagar_Click1(object sender, EventArgs e)
        {
            ...
            aSQL.Parameters.AddWithValue("@comentario_id", int.Parse(comentario_id));
