...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="LabelFilme_id" runat="server" Text="Label" Visible="False"></asp:Label>
        &nbsp;<asp:ImageButton ID="ImageButtonFavorito" runat="server" Height="50px" ImageUrl="~/Imagens/favoritarButton.png" OnClick="ImageButton1_Click" Width="50px" />
...
&nbsp;
    <asp:ImageButton ID="ImageButtonInteresse" runat="server" Height="45px" ImageUrl="~/Imagens/tvInteresseButton.png" OnClick="ImageButtonInteresse_Click" Width="48px" />
        ...
        <br />
        <br />
        <asp:ImageButton ID="ImageButtonEstrela1" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" onmouseover="acenderImagem()" Width="100px" />
        <asp:ImageButton ID="ImageButtonEstrela2" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" Width="100px" />
        <asp:ImageButton ID="ImageButtonEstrela3" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" Width="100px" />
        <asp:ImageButton ID="ImageButtonEstrela4" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" Width="100px" />
        <asp:ImageButton ID="ImageButtonEstrela5" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" Width="100px" />
        <asp:ImageButton ID="ImageButtonEstrela6" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" Width="100px" />
        <asp:ImageButton ID="ImageButtonEstrela7" runat="server" ImageUrl="~/Imagens/estrelaApagada.jpg" Width="100px" />
        <br />
